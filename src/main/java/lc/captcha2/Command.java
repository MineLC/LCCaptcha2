...
public class Command implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String s, String[] args) {
        ...
        if(args[0].equalsIgnoreCase(LCCaptcha2.player_catpchat.get(p))){
            LCCaptcha2.playerkick.remove(p);
            ...
            p.sendPluginMessage(LCCaptcha2.getPlugin(LCCaptcha2.class), "captcha:channel", b.toByteArray());
        } else {
